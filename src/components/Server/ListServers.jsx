          ...
          {data.length>0 ? (<table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 table table-auto">
            ...
            <tbody>
              {data.map((data)=><tr key={data._id} className="bg-gray-900 border-b dark:bg-gray-800 dark:border-gray-700 text-white">
                ...
                <td className="lg:px-6 lg:py-3">{data.ipAddress?data.ipAddress:""}</td>
                <td className="lg:px-6 lg:py-3">{data.location?data.location:""}</td>
                <td className="lg:px-6 lg:py-3">{data.status?data.status:""}</td>
                <td className="lg:px-6 lg:py-3">{data.uptime?data.uptime:""}</td>
                <td className="lg:px-6 lg:py-3">{data.type?data.type:""}</td>
                <td className="lg:px-6 lg:py-3">{formatDate(data.lastMaintenanceDate)?formatDate(data.lastMaintenanceDate):""}</td>
